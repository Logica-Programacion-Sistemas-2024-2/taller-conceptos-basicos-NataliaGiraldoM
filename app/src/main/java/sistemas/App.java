...
public class App {
    ...
    public static int calcularCombustible(double ruta1, double ruta2, double ruta3, double ruta4) {
        try {
            ...
            double totalKilometraje = ruta1 + ruta2 + ruta3 + ruta4;

            double consumoCrucero = totalKilometraje * consumoPorKm;
            double consumoTotal = consumoCrucero + (despegue + aterrizaje) * 4;

            return (int) consumoTotal;
    ...
    public static int calcularPesoLunar(double pesoTierra) {
        try {
            ...
            double gravedadLunar = 0.17;

            double pesoLuna = pesoTierra * gravedadLunar;
    ...
    public static int calcularNotaFinal(double nota1, double nota2, double nota3, double nota4, double nota5,
        ...
        try {
            ...
            if (sumaPorcentajes != 100) {
                System.out.println("Error: Los porcentajes deben sumar 100.");
                return -1;
            }
    ...
    public static int calcularNotaNecesaria(double porcentaje1, double porcentaje2, double porcentaje3, double porcentaje4, double porcentaje5, double nota1, double nota2, double nota3, double nota4) {
        ...
        try {
            ...
            double puntajeAcumulado = (nota1 * porcentaje1 / 100) + (nota2 * porcentaje2 / 100) + (nota3 * porcentaje3 / 100) + (nota4 * porcentaje4 / 100);

            double puntajeNecesario = 3 - puntajeAcumulado;

            double notaNecesaria = puntajeNecesario * 100 / porcentaje5;
    ...
    public static int calcularPerimetroCuadrado(double lado) {
        ...
        try {
            if (lado <= 0) {
                System.out.println("Error: El lado debe ser mayor que cero.");
                return -1;
            }
